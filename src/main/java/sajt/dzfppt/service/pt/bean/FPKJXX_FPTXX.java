...
public class FPKJXX_FPTXX implements Serializable{
	...
	public String toString() {
		return "FPKJXX_FPTXX [FPQQLSH=" + FPQQLSH + ", DSPTBM=" + DSPTBM
				+ ", NSRSBH=" + NSRSBH + ", NSRMC=" + NSRMC + ", NSRDZDAH="
				+ NSRDZDAH + ", SWJG_DM=" + SWJG_DM + ", DKBZ=" + DKBZ
				+ ", PYDM=" + PYDM + ", KPXM=" + KPXM + ", BMB_BBH=" + BMB_BBH
				+ ", XHF_NSRSBH=" + XHF_NSRSBH + ", XHFMC=" + XHFMC
				+ ", XHF_DZ=" + XHF_DZ + ", XHF_DH=" + XHF_DH + ", XHF_YHZH="
				+ XHF_YHZH + ", GHFMC=" + GHFMC + ", GHF_NSRSBH=" + GHF_NSRSBH
				+ ", GHF_SF=" + GHF_SF + ", GHF_DZ=" + GHF_DZ + ", GHF_GDDH="
				+ GHF_GDDH + ", GHF_SJ=" + GHF_SJ + ", GHF_EMAIL=" + GHF_EMAIL
				+ ", GHFQYLX=" + GHFQYLX + ", GHF_YHZH=" + GHF_YHZH
				+ ", HY_DM=" + HY_DM + ", HY_MC=" + HY_MC + ", KPY=" + KPY
				+ ", SKY=" + SKY + ", FHR=" + FHR + ", KPRQ=" + KPRQ
				+ ", KPLX=" + KPLX + ", YFP_DM=" + YFP_DM + ", YFP_HM="
				+ YFP_HM + ", CZDM=" + CZDM + ", QD_BZ=" + QD_BZ + ", QDXMMC="
				+ QDXMMC + ", CHYY=" + CHYY + ", TSCHBZ=" + TSCHBZ
				+ ", KPHJJE=" + KPHJJE + ", HJBHSJE=" + HJBHSJE + ", HJSE="
				+ HJSE + ", BZ=" + BZ + ", BYZD1=" + BYZD1 + ", BYZD2=" + BYZD2
				+ ", BYZD3=" + BYZD3 + ", BYZD4=" + BYZD4 + ", BYZD5=" + BYZD5
				+ "]";
	}
